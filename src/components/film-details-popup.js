export const createFilmDetailsPopup = (filmСard, comments) => {
  const {title, rating, year, duration, genre, image, description, commentsCount, director, writers, actors, releaseDate} = filmСard;
  const {text, emoji, author, date} = comments;
  return (
    `
